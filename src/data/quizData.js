export const quizData = {
  ...
  english_grammar: {
    ...
    description: "Fill in the gaps with the correct forms of verbs in brackets.",
    questions: [
      {
        id: 1,
        type: "fill_blank",
        question: "Police _______ (arrest) more than 900 suspected drugs traffickers in raids through out the country on Friday and Saturday.",
      ...
      },
      {
        id: 5,
        type: "fill_blank",
        question: "I _______ (interview) on the radio tomorrow about my new book.",
      ...
      },
      {
        id: 7,
        type: "fill_blank",
        question: "She isn't here today. She only _______ (work) four days a week.",
        answer: ["works"]
      },
      {
        id: 8,
      ...
      },
      {
        id: 9,
        type: "fill_blank",
        question: "I _______ (watch) old movies on TV. Then I suddenly had a great idea for a script.",
        answer: ["was watching"]
      },
      {
        id: 10,
        type: "fill_blank",
        question: "The vegetable didn't taste very good. They _______ (cook) too long.",
      ...
      },
      {
        id: 14,
        type: "fill_blank",
        question: "Sorry I'm late. That's all right. I _______ (not/wait) long.",
      ...
      },
      {
        id: 18,
        type: "fill_blank",
        question: "A 24-year-old soldier _______ (kill) in a road accident last night.",
        answer: ["has been killed", "was killed"]
      },
      {
        id: 19,
        type: "fill_blank",
        question: "I _______ (study) chemistry for three years and there's another year to go.",
        answer: ["have been studying"]
      },
      {
        id: 20,
        type: "fill_blank",
        question: "Rachel went to Sue's house, but she wasn't there. She _______ (go) out.",
        answer: ["had gone"]
      }
    ]
  }
